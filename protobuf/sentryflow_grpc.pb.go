...
func (c *sentryFlowClient) GetAPIMetrics(ctx context.Context, in *ClientInfo, opts ...grpc.CallOption) (*APIMetric, error) {
	out := new(APIMetric)
	err := c.cc.Invoke(ctx, SentryFlow_GetAPIMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SentryFlow_GetAPIMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClientInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SentryFlowServer).GetAPIMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SentryFlow_GetAPIMetrics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SentryFlowServer).GetAPIMetrics(ctx, req.(*ClientInfo))
	}
