...
with [Nginx Inc.](https://github.com/nginxinc/kubernetes-ingress/) Ingress Controller, aimed at enhancing API
...
- [Nginx njs](https://github.com/nginx/njs) module.
...
To Observe API calls of your workloads running served by Nginx inc. ingress controller in Kubernetes environment, follow the below
steps:
